...
CREATE TABLE IF NOT EXISTS buses (
  ...
  bus_type varchar(50) DEFAULT 'seater',
  status varchar(50) DEFAULT 'active',
  created_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (id)
...
CREATE TABLE IF NOT EXISTS cruises (
  ...
  cabin_type varchar(50) DEFAULT 'inside',
  amenities text,
  description text,
...
CREATE TABLE IF NOT EXISTS holiday_packages (
  ...
  package_type varchar(50) DEFAULT 'family',
  includes_flights integer DEFAULT '0',
  description text,
  itinerary text,
  image_url varchar(500) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS trains (
  ...
  class_type varchar(50) DEFAULT 'sleeper',
  status varchar(50) DEFAULT 'active',
  created_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (id)
...
-- Synchronize PostgreSQL identity sequences after importing explicit IDs.
...
SELECT setval(pg_get_serial_sequence('buses', 'id'), COALESCE((SELECT MAX(id) FROM buses), 1), true);
SELECT setval(pg_get_serial_sequence('cruises', 'id'), COALESCE((SELECT MAX(id) FROM cruises), 1), true);
SELECT setval(pg_get_serial_sequence('flights', 'id'), COALESCE((SELECT MAX(id) FROM flights), 1), true);
SELECT setval(pg_get_serial_sequence('holiday_packages', 'id'), COALESCE((SELECT MAX(id) FROM holiday_packages), 1), true);
...
SELECT setval(pg_get_serial_sequence('trains', 'id'), COALESCE((SELECT MAX(id) FROM trains), 1), true);
